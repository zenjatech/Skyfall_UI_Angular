...
const I: Record<string, string> = {
  ...
  'table-2': `<path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v11m0 0H5a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-4m-6 0h.01"/>`,
  'credit-card': `<rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/>`,
  'users': `<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>`,
  'bar-chart-3': `<path d="M3 3v18h18"/><path d="M18 17V9"/><path d="M13 17V5"/><path d="M8 17v-3"/>`,
  'megaphone': `<path d="m3 11 18-5v12L3 14v-3Z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/><path d="M3 11v3"/>`,
...
@Component({
  ...
  template: `<svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24"
    fill="none" stroke="currentColor" [attr.stroke-width]="sw"
...
export class IconComponent {
  ...
  @Input() sw = 1.8;
  get path(): SafeHtml {
    return this.san.bypassSecurityTrustHtml(I[this.name] ?? '');
  }
}
